        ...
        <section className="mx-auto max-w-4xl space-y-16">
          ...
          <Reveal delay={150}>
            <div className="grid gap-8 md:grid-cols-[1fr_1.5fr] items-start p-8 rounded-3xl border border-border/40 bg-background/40">
              <div className="flex flex-col justify-between h-full space-y-6">
                ...
                <div>
                  <h2 className="text-display text-2xl font-bold">Why Does Gold Investment Have Tax?</h2>
                  <p className="text-xs uppercase tracking-wider text-foreground/45 mt-1">Capital gains explained</p>
                </div>
              </div>
              <div className="space-y-4 text-foreground/80 text-sm leading-relaxed">
                ...
                <p>
                  Whenever you make a profit from an investment, the government may charge tax on that profit. This profit is called a <strong className="text-foreground">capital gain</strong>.
                </p>
                <div className="rounded-2xl border border-border/30 bg-background/20 p-4 space-y-2">
                  <span className="text-xs uppercase tracking-wider text-amber-700 font-semibold block">Example</span>
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between"><span>You buy gold for</span><span className="font-semibold">₹50,000</span></div>
                    <div className="flex justify-between"><span>You sell it for</span><span className="font-semibold">₹70,000</span></div>
                    <div className="flex justify-between border-t border-border/20 pt-1 mt-1 font-bold text-foreground"><span>Your taxable profit</span><span>₹20,000</span></div>
                  </div>
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-2xl border border-border/30 bg-background/30 p-6 space-y-3">
                  <span className="text-xs uppercase tracking-wider text-amber-700 font-semibold block">When You Buy Gold</span>
                  <p className="text-sm text-foreground/75 leading-relaxed">
                    You pay <strong className="text-foreground">3% GST</strong> on the value of gold. If you're buying jewelry, GST may also apply to making charges separately.
                  </p>
                </div>
                <div className="rounded-2xl border border-border/30 bg-background/30 p-6 space-y-3">
                  <span className="text-xs uppercase tracking-wider text-amber-700 font-semibold block">When You Sell Gold</span>
                  <p className="text-sm text-foreground/75 leading-relaxed">
                    If you sell gold at a profit, <strong className="text-foreground">capital gains tax</strong> may apply. For example: Purchase ₹1,00,000 → Sale ₹1,40,000 → Taxable profit of ₹40,000.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Reveal>
            <div className="space-y-8">
              ...
              <p className="text-sm text-foreground/75 leading-relaxed">
                Digital Gold allows investors to buy gold online through apps and platforms. Tax treatment is generally <strong className="text-foreground">similar to physical gold</strong>.
              </p>
              <div className="rounded-2xl border border-border/30 bg-background/20 p-6 space-y-4">
                <span className="text-xs uppercase tracking-wider text-amber-700 font-semibold block">Key Points</span>
                <ul className="space-y-2 text-sm text-foreground/80">
                  <li className="flex items-center gap-2"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> No annual interest income</li>
                  <li className="flex items-center gap-2"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Tax may apply when sold at a profit</li>
                  <li className="flex items-center gap-2"><Check className="h-4 w-4 text-emerald-600 shrink-0" /> Purchase records should be maintained carefully</li>
                </ul>
            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-2xl border border-border/30 bg-background/20 p-6 space-y-3">
                  <span className="text-xs uppercase tracking-wider text-amber-700 font-semibold block">Interest Income</span>
                  <p className="text-sm text-foreground/75 leading-relaxed">
                    Gold ETFs <strong className="text-foreground">do not provide</strong> any interest income. Returns come purely from gold price appreciation.
                  </p>
                </div>
                <div className="rounded-2xl border border-border/30 bg-background/20 p-6 space-y-3">
                  <span className="text-xs uppercase tracking-wider text-amber-700 font-semibold block">On Sale / Capital Gains</span>
                  <p className="text-sm text-foreground/75 leading-relaxed">
              ...
              <div className="rounded-2xl border border-[#D4AF37]/25 bg-amber-500/[0.03] p-5">
                <span className="text-xs uppercase tracking-wider text-amber-700 font-semibold block mb-3">
                  <Info className="h-3.5 w-3.5 inline mr-1" />Keep These Records
                </span>
                <div className="flex flex-wrap gap-3">
                  {["Purchase date", "Purchase price", "Sale value"].map((item) => (
                    <span key={item} className="rounded-full border border-amber-300/30 bg-amber-500/5 px-3 py-1.5 text-xs font-semibold text-amber-800">
                      {item}
                    </span>
                  ))}
                </div>
                <p className="text-xs text-foreground/55 mt-3">These details are required while filing income tax returns.</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="space-y-8">
              ...
              <div className="rounded-2xl border border-border/30 bg-background/20 p-6 space-y-2">
                ...
                <p className="text-sm text-foreground/75 leading-relaxed">
                  SGBs provide <strong className="text-foreground">2.5% annual interest</strong>. This interest is taxable and must be reported while filing your income tax return.
                </p>
              </div>

              {/* 2026 Rule Change — highlighted callout */}
              <div className="glass-dark relative overflow-hidden rounded-3xl p-8 text-white">
                <div className="absolute -top-16 -right-16 h-48 w-48 rounded-full" style={{ background: "radial-gradient(circle, rgba(244,208,63,0.28), transparent 65%)" }} />
                <div className="relative z-10 space-y-5">
                  <div className="flex items-center gap-3">
                    <AlertTriangle className="h-5 w-5 text-amber-400 shrink-0" />
                    <span className="eyebrow-tag" style={{ color: "var(--gold-bright)" }}>Important 2026 Tax Rule Change</span>
                  </div>
                  <p className="text-sm text-white/85 leading-relaxed">
                    A major tax rule changed from <strong className="text-white">1 April 2026</strong>. Earlier, investors who held SGBs until maturity generally enjoyed tax-free capital gains. The exemption is now conditional.
                  </p>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-5 space-y-3">
                      <span className="text-xs font-bold uppercase tracking-wider text-emerald-300 block">✅ Still Gets Tax-Free Benefits</span>
                      <ul className="space-y-2 text-xs text-white/85">
                        <li className="flex items-start gap-2"><Check className="h-3.5 w-3.5 text-emerald-400 shrink-0 mt-0.5" />Purchased SGB during the original RBI issue</li>
                        <li className="flex items-start gap-2"><Check className="h-3.5 w-3.5 text-emerald-400 shrink-0 mt-0.5" />Held continuously until maturity</li>
                      </ul>
                    </div>
                    <div className="rounded-2xl border border-red-400/20 bg-red-500/10 p-5 space-y-3">
                      <span className="text-xs font-bold uppercase tracking-wider text-red-300 block">❌ Will Pay Capital Gains Tax</span>
                      <ul className="space-y-2 text-xs text-white/85">
                        <li className="flex items-start gap-2"><X className="h-3.5 w-3.5 text-red-400 shrink-0 mt-0.5" />Purchased SGBs from the stock exchange (secondary market)</li>
                        <li className="flex items-start gap-2"><X className="h-3.5 w-3.5 text-red-400 shrink-0 mt-0.5" />Sold before maturity</li>
                        <li className="flex items-start gap-2"><X className="h-3.5 w-3.5 text-red-400 shrink-0 mt-0.5" />Received SGBs through transfer (not original subscriber)</li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <Reveal>
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-display text-2xl">Which Gold Investment Is Most Tax Friendly?</h2>
              </div>
                  ...
                  <table className="w-full text-left text-sm border-collapse min-w-[600px]">
                    <thead>
                      <tr className="bg-foreground/[0.02] hairline-b">
                        ...
                        <th className="px-6 py-4 text-display text-base text-amber-800">Interest Income</th>
                        <th className="px-6 py-4 text-display text-base text-foreground/70">Tax Benefit</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-border/20">
                      {taxTable.map((row) => (
                        <tr key={row.type} className="hover:bg-foreground/[0.01] transition-colors">
                          <td className="px-6 py-4 font-semibold text-foreground/85">
                            {row.type}
                          </td>
                          <td className="px-6 py-4 text-foreground/70">{row.interest}</td>
                          <td className="px-6 py-4">
                            <span className={`inline-flex items-center gap-1.5 text-xs font-semibold ${row.friendly ? "text-emerald-700" : "text-foreground/60"}`}>
            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-6 sm:grid-cols-3">
                {tipCards.map((tip, idx) => (
                  <div key={idx} className="rounded-2xl border border-border/30 bg-background/30 p-6 space-y-4">
