          ...
          <Reveal>
            <div className="glass-dark relative overflow-hidden p-8 text-center text-white sm:p-12">
              ...
              <div className="mt-8 flex justify-center gap-4 flex-wrap">
                <a href="#" className="btn-gold btn-gold-hover inline-flex items-center gap-2 rounded-full px-6 py-3 text-xs font-semibold">
                  Start Investing <ArrowRight className="h-3.5 w-3.5" />
                </a>
                <a href="#" className="inline-flex items-center gap-2 rounded-full border border-white/25 px-6 py-3 text-xs font-semibold text-white hover:bg-white/10 transition-colors">
                  Contact Advisor
                </a>
              </div>
            </div>
