        ...
        <section className="mx-auto max-w-4xl mb-16">
          ...
          <Reveal delay={100}>
            ...
            <p className="mt-8 text-base sm:text-lg text-foreground/80 leading-relaxed font-sans max-w-3xl">
              Gold Exchange Traded Funds (ETFs) allow you to invest in gold digitally through stock
              exchanges. Each unit represents gold held by the fund, providing a convenient and
              secure way to participate in gold price movements without worrying about storage,
              security, or purity.
            </p>
          </Reveal>
        </section>
