        ...
        <section className="mx-auto max-w-4xl mb-16">
          ...
          <Reveal delay={100}>
            ...
            <p className="mt-8 text-base sm:text-lg text-foreground/80 leading-relaxed font-sans max-w-3xl">
              Gold Mutual Funds are open-ended investment schemes that invest primarily in Gold
              ETFs. They allow retail investors to gain exposure to gold prices easily, offering
              options like Systematic Investment Plans (SIPs) without needing a Demat account or
